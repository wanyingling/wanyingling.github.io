...
Drawing on large-scale surveys and quantitative methods to analyze how time-related exposures and timing shape health and subjective well-being.
...
Using life expectancy and derived indicators to map population-level patterns and changes in the organization of life time.
...
Leveraging novel data sources and analytic strategies to capture macro-level transformations and micro-level choices.
...
- Generative AI vs. Human Responses: A Factorial Survey Experiment on Fertility Intentions in China., with Senhu Wang (National University of Singapore), Qi Xu (Nanjing University).

- Structural Constraints on Fertility Intentions Across National Contexts: Evidence from a Six-Country Factorial Survey Experiment, with Senhu Wang (National University of Singapore), Sinn Won Han (Yonsei University), Qi Xu (Nanjing University).
